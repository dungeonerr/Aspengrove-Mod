...
public class NBTfiedConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        register(context, V1_TEST_TREE1, NBTfiedTreesFeatures.NBT_TREE_V1.get(), new NBTTreeFeatureConfig.Builder()
                ...
                .maxLogDepth(3)
                .treeDecorators(List.of(new AlterGroundDecorator(BlockStateProvider.simple(Blocks.MOSS_BLOCK))))
                .build());

        register(context, V1_TEST_TREE2, NBTfiedTreesFeatures.NBT_TREE_V1.get(), new NBTTreeFeatureConfig.Builder()
                .baseLocation(NBTfiedTrees.id("features/trees/testv1/test_tree_trunk1"))
                .canopyLocation(NBTfiedTrees.id("features/trees/testv1/test_tree_canopy1"))
                .height(UniformInt.of(5, 10))
        ...
        register(context, V1_UPSIDE_DOWN_TEST_TREE1, NBTfiedTreesFeatures.NBT_TREE_V1.get(), new NBTTreeFeatureConfig.Builder()
                .baseLocation(NBTfiedTrees.id("features/trees/testv1/test_tree_trunk1"))
                .canopyLocation(NBTfiedTrees.id("features/trees/testv1/test_tree_canopy1"))
                .height(UniformInt.of(5, 10))
                .logProvider(BlockStateProvider.simple(Blocks.ACACIA_LOG))
        ...
        register(context, V2_TEST_TREE1, NBTfiedTreesFeatures.NBT_TREE_V2.get(), new NBTTreeFeatureConfigV2.Builder()
    ...
    public static void register() {
        // Пустой метод, чтобы не вызывать раннюю инициализацию статических полей
    }
}