...
public class AspenGroveItems {
    public static final Item ASPEN_BOAT = registerBoat("aspen_boat", AspenGroveBoatType.ASPEN, false);

    public static final Item ASPEN_CHEST_BOAT = registerBoat("aspen_chest_boat", AspenGroveBoatType.ASPEN, true);
