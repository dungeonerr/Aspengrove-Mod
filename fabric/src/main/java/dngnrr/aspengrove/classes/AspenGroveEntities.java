...
public class AspenGroveEntities {
    public static final EntityType<AspenGroveBoatEntity> ASPEN_BOAT = register("aspen_boat",
            EntityType.Builder.<AspenGroveBoatEntity>of(AspenGroveBoatEntity::new, MobCategory.MISC)
                    .sized(1.375F, 0.5625F)
                    .clientTrackingRange(10));

    public static final EntityType<AspenGroveChestBoatEntity> ASPEN_CHEST_BOAT = register("aspen_chest_boat",
